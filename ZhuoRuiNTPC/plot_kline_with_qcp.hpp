#ifndef PLOTKLINEWITHQCP_HPP
#define PLOTKLINEWITHQCP_HPP

#include<QVector>
#include "my_custom_plot.hpp"

// 这是利用Qt第三方库QCustomPlot来画的k线，功能丰富
...
void setupShangHaiIndexDemo(QCustomPlot *customPlot)
{
    ...
    //QSharedPointer<QCPAxisTickerText> textTicker(new QCPAxisTickerText);     // 文字轴
